...
public class ManagerTest {
	...
	public void setUp() throws Exception {
		...
		set(new TokenizerUtil(), new EntityRetriever(), new TextExtractor(), new Storage());
	...
	public void set(TokenizerUtil tokenizer, EntityRetriever entityRetriever, TextExtractor textExtractor, Storage storage) {
