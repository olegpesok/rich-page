...
public class ManagerTest {
	...
	public void setUp() throws Exception {
		...
		set(new Tokenizer(), new EntityRetriever(), new TextExtractor(), new Storage());
	...
	public void set(Tokenizer tokenizer, EntityRetriever entityRetriever, TextExtractor textExtractor, Storage storage) {
